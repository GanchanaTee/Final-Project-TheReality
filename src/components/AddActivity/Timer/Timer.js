...
function Timer(props) {
  ...
  return (
    <div className='acitivity-right-timer'>
                    ...
                    <div className='activity-right-timer-button'>
                        <button className={`button button-primary button-primary-${props.isActive ? 'active' : 'inactive'}`} onClick={toggle}>
